...
Even with a filter of >=5 tpm the cor between vRNA and agRNA doesn't get better. There is still a difference in the RNA found in the venom gland vs the venom. 
```{r,message=F}

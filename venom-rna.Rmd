...
d <- taiwan_merged2 %>% ungroup %>% select(-gene, -taiwan2, -P_m_05_heart) 
...
ggplot(plotDat, aes(x,y,color = tissue)) + geom_point(size=3) + theme_bw() + geom_path(data=conf.rgn) + xlab("NMDS Axis 1") + ylab("NMDS Axis 2")
ggsave("plots/Figure 2 NMDS.pdf", height=5, width = 6)
```
